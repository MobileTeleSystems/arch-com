...
- [Описание требований и архитектуры](#описание-требований-и-архитектуры)
  ...
  - [Бизнес-контекст](#бизнес-контекст)
    ...
    - [Бизнес-архитектура](#бизнес-архитектура)
      - [Диаграмма потока ценности](#диаграмма-потока-ценности)
  - [Глоссарий](#глоссарий)
...
### Бизнес-архитектура
<!-- Представление отображает сервисы создаваемой системы в контексте продукта и компании в целом, в привязке к капабилити, разложенным по этапам потока ценности 
Подробнее: https://confluence.mts.ru/pages/viewpage.action?pageId=735512879 -->

#### Диаграмма потока ценности

![Диаграмма потока ценности](ba/vs.drawio.png)
